...
// Confirm Dialog State
  ...
  const handleAddNote = () => {
    ...
    const newNoteObj: ClientNote = { id: Date.now().toString(), text: newNote, date: new Date(), author: currentUser.nickname };
    ...
    return (
      <div className="h-full flex flex-col bg-slate-900">
        <header className="p-6 border-b border-slate-700 bg-slate-800 flex items-center gap-4">
          ...
          {hasChanges && <div className="ml-auto flex items-center gap-2 animate-in fade-in slide-in-from-right-4"><span className="text-sm text-amber-500 italic">Unsaved changes</span></div>}
        </header>
