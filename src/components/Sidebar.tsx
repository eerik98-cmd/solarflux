...
import { LayoutDashboard, Box, Bot, Sun, Battery, Settings, FileText, Users, Wrench } from 'lucide-react';
// import { View } from '../types';

export type View = any; // Replace 'any' with the actual View type definition
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView = 'DASHBOARD', onChangeView = () => {}, onLogout }) => {
  const navItems = [
    ...
    { id: 'AI_ASSISTANT', label: 'AI Manager', icon: Bot },
  ];
